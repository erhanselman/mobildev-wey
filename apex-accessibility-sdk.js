(function (global) {
    ...
    const ApexAccessibilitySDK = {
        defaultOptions: {
            ...
            helpers: {
                epilepsy: "Nöbet be epilepsi riski olan kullanıcılar için animasyon parlaklık ayarları yapar",
                lowvision: "Kısıtlı görme engelli kullanıcılara için metin boyutu ve yüksek renk ayarları yapar",
                adhd: "Dikkat eksikliği ve hiperaktivitesi olan kullanıcılar için odak ayarları yapar",
                blind: "Görme engelli kullanıcılar için ses okumayı aktif yapar",
                dyslexia: "Disleksi olan kullanıcılar için okuma fontu değişiklik ayarı yapar",
                elderly: "Yaşlı kullanıcılar için metin boyutu ve renk ayarları yapar",

                profiles: 'Kullanıcılar için ortak olan önceden tanımlanmış erişilebilirlik özellikleri arasından seçim yapın.'
            }
        },
        ...
        createStyles: function (config) {
            ...
            body.${p}-cb-protanopia {
                filter: hue-rotate(-20deg) saturate(1.3) contrast(1.1) !important;
            }
            
            body.${p}-cb-deuteranopia {
                filter: sepia(1) hue-rotate(180deg) saturate(1.6) brightness(1.05) !important;
            }
            
            body.${p}-cb-tritanopia {
                filter: hue-rotate(180deg) saturate(0.3) contrast(1.4) brightness(1.1) !important;
            }
            
            body.${p}-bluelight-low {
                filter: sepia(0.3) hue-rotate(180deg) saturate(1.3) brightness(0.97) !important;
            }
            
            body.${p}-bluelight-medium {
                filter: sepia(0.6) hue-rotate(185deg) saturate(1.6) brightness(0.94) !important;
            }
            
            body.${p}-bluelight-high {
                filter: sepia(0.9) hue-rotate(190deg) saturate(2.1) brightness(0.90) contrast(1.05) !important;
            }
            
            body {
            
                filter:
                    brightness(var(--${p}-brightness, 100%)) grayscale(var(--${p}-monochrome, 0%)) saturate(var(--${p}-saturate, 100%)) contrast(var(--${p}-contrast, 1)) invert(var(--${p}-invert, 0));
            ...
            * {
            ...
            .${p}-section-title .${p}-helper-tooltip {
                position: relative;
                right: -4px;
                top: -5px;
            }
            
            .${p}-section-title .${p}-helper-tooltip>div {
                font-size: 0.7em;
                left: 2px;
                right: auto;
            }
            ...
            .${p}-control-grid-1col .${p}-control-item {
                flex-direction: column;
                height: 100px;
                padding: 12px;
            }
            
            .${p}-control-grid-1col .${p}-control-item>div {
                flex-direction: column;
                gap: 2px;
            }
            ...
            .${p}-control-item[data-action="active"] {
                background: #dbeafe;
            }
            ...
            .${p}-open-menu-btn {
                ...
                box-shadow: 0 0 0 3px var(--${p}-primary);
                z-index: 9999;
                padding: 0;
            }
            ...
            section.${p}-sections-langs.active {
                height: 100%;
                opacity: 1;
                visibility: visible;
            }
            
            button#${p}-close-langs {
                border: none;
            ...
            section.${p}-sections-langs .scroll-content {
                display: flex;
                flex-direction: column;
                height: 100%;
                overflow: auto;
            ...
            section.${p}-sections-langs .scroll-content>button {
                box-shadow: none;
                cursor: pointer;
                border: none;
                border-radius: 20px;
            ...
            section.${p}-sections-langs .scroll-content>button:hover {
                background: #000 !important;
                color: #fff;
            }
            
            section.${p}-sections-langs .scroll-content>button span {
            ...
            section.${p}-sections-langs .scroll-content>button img {
                -o-object-fit: cover;
                object-fit: cover;
                border-radius: 50%;
                width: 25px;
            ...
            body.${p}-font-atkinson {
                font-family: 'Atkinson Hyperlegible', sans-serif !important;
            }
            
            body.${p}-font-dyslexic {
        ...
        createHTML: function (config) {
            ...
            container.innerHTML = `
                ...
                <div class="apex-sdk-container-layer-wrap">
                    <section id="${p}-sections-langs" class="${p}-sections-langs">
                    <button id="${p}-close-langs">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24" fill="none"><path d="M14.5 9.50002L9.5 14.5M9.49998 9.5L14.5 14.5" stroke="#000" stroke-width="1.5" stroke-linecap="round"/><path d="M22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C21.5093 4.43821 21.8356 5.80655 21.9449 8" stroke="#000" stroke-width="1.5" stroke-linecap="round"/></svg></button>
                    <div class="scroll-content" style="transform: translate3d(0px, 0px, 0px);">
            <button aria-label="English" tabindex="1" class="co" data-lang="en" style="">
                <span>English</span>
            </button>
            <button aria-label="Arabic" tabindex="1" class="co" data-lang="ar">
                <span>Arabic</span>
            </button>
            <button aria-label="Azerbaijan" tabindex="1" class="co" data-lang="az">
                <span>Azerbaijan</span>
            </button>
            <button aria-label="Bulgarian" tabindex="1" class="co" data-lang="bg">
                <span>Bulgarian</span>
            </button>
            <button aria-label="Chinese" tabindex="1" class="co" data-lang="zh-CN">
                <span>Chinese</span>
            </button>
            <button aria-label="Chinese" traditional="" tabindex="1" class="co" data-lang="zh-TW">
                <span>Chinese traditional</span>
            </button>
            <button aria-label="Czech" (Čeština)="" tabindex="1" class="co" data-lang="cs">
                <span>Czech (Čeština)</span>
            </button>
            <button aria-label="Croatian" tabindex="1" class="co" data-lang="hr">
                <span>Croatian</span>
            </button>
            <button aria-label="Danish" (dansk)="" tabindex="1" class="co" data-lang="da">
                <span>Danish (Dansk)</span>
            </button>
            <button aria-label="Dutch" (nederlands)="" tabindex="1" class="co" data-lang="nl">
                <span>Dutch (Nederlands)</span>
            </button>
            <button aria-label="Estonian" (eesti="" keel)="" tabindex="1" class="co" data-lang="et">
                <span>Estonian (Eesti keel)</span>
            </button>
            <button aria-label="Finnish" (suomi)="" tabindex="1" class="co" data-lang="fi">
                <span>Finnish (Suomi)</span>
            </button>
            <button aria-label="French" tabindex="1" class="co" data-lang="fr">
                <span>French</span>
            </button>
            <button aria-label="Georgian" tabindex="1" class="co" data-lang="ka">
                <span>Georgian</span>
            </button>
            <button aria-label="German" tabindex="1" class="co" data-lang="de">
                <span>German</span>
            </button>
            <button aria-label="Greek" (Ελληνικά)="" tabindex="1" class="co" data-lang="el">
                <span>Greek (Ελληνικά)</span>
            </button>
            <button aria-label="Hebrew" (עברית)="" tabindex="1" class="co" data-lang="iw">
                <span>Hebrew (עברית)</span>
            </button>
            <button aria-label="Hindi" (हिंदी)="" tabindex="1" class="co" data-lang="hi">
                <span>Hindi (हिंदी)</span>
            </button>
            <button aria-label="Hungarian" (magyar)="" tabindex="1" class="co" data-lang="hu">
                <span>Hungarian (Magyar)</span>
            </button>
            <button aria-label="Indonesian" (bahasa="" indonesia)="" tabindex="1" class="co" data-lang="id">
                <span>Indonesian (Bahasa Indonesia)</span>
            </button>
            <button aria-label="Italian" tabindex="1" class="co" data-lang="it">
                <span>Italian</span>
            </button>
            <button aria-label="Japanese" (日本語)="" tabindex="1" class="co" data-lang="ja">
                <span>Japanese (日本語)</span>
            </button>
            <button aria-label="Kazakh" tabindex="1" class="co" data-lang="kk">
                <span>Kazakh</span>
            </button>
            <button aria-label="Korean" tabindex="1" class="co" data-lang="ko">
                <span>Korean</span>
            </button>
            <button aria-label="Lithuanian" (lietuvių)="" tabindex="1" class="co" data-lang="lt">
                <span>Lithuanian (Lietuvių)</span>
            </button>
            <button aria-label="Montenegrin" cyrillic="" tabindex="1" class="co" data-lang="mnec">
                <span>Montenegrin Cyrillic</span>
            </button>
            <button aria-label="Montenegrin" latin="" tabindex="1" class="co" data-lang="mnel">
                <span>Montenegrin Latin</span>
            </button>
            <button aria-label="Norwegian" (norsk)="" tabindex="1" class="co" data-lang="no">
                <span>Norwegian (Norsk)</span>
            </button>
            <button aria-label="Persian" (فارسی)="" tabindex="1" class="co" data-lang="fa">
                <span>Persian (فارسی)</span>
            </button>
            <button aria-label="Polish" tabindex="1" class="co" data-lang="pl">
                <span>Polish</span>
            </button>
            <button aria-label="Portugal" (brazil)="" tabindex="1" class="co" data-lang="pt">
                <span>Portugal (Brazil)</span>
            </button>
            <button aria-label="Portugal" (português)="" tabindex="1" class="co" data-lang="pt-PT">
                <span>Portugal (Português)</span>
            </button>
            <button aria-label="Romanian" (română)="" tabindex="1" class="co" data-lang="ro">
                <span>Romanian (Română)</span>
            </button>
            <button aria-label="Russian" tabindex="1" class="co" data-lang="ru">
                <span>Russian</span>
            </button>
            <button aria-label="Serbian" cyrillic="" tabindex="1" class="co" data-lang="srbc">
                <span>Serbian Cyrillic</span>
            </button>
            <button aria-label="Serbian" latin="" tabindex="1" class="co" data-lang="srbl">
                <span>Serbian Latin</span>
            </button>
            <button aria-label="Slovak" (slovenský)="" tabindex="1" class="co" data-lang="sk">
                <span>Slovak (Slovenský)</span>
            </button>
            <button aria-label="Slovenian" (slovenščina)="" tabindex="1" class="co" data-lang="sl">
                <span>Slovenian (Slovenščina)</span>
            </button>
            <button aria-label="Spanish" (espanol)="" tabindex="1" class="co" data-lang="es">
                <span>Spanish (Espanol)</span>
            </button>
            <button aria-label="Swedish" (svenska)="" tabindex="1" class="co" data-lang="sv">
                <span>Swedish (Svenska)</span>
            </button>
            <button aria-label="Turkish" tabindex="1" class="co active" data-lang="tr">
                <span>Turkish</span>
            </button>
            <button aria-label="Ukrainian" (Українська)="" tabindex="1" class="co" data-lang="uk">
                <span>Ukrainian (Українська)</span>
            </button>
            <button aria-label="Uzbek" tabindex="1" class="co" data-lang="uz">
                <span>Uzbek</span>
            </button>
            <button aria-label="Welsh" (cymraeg)="" tabindex="1" class="co" data-lang="cy">
                <span>Welsh (Cymraeg)</span>
            </button>
            <button aria-label="Vietnamese" (việt="" nam)="" tabindex="1" class="co" data-lang="vi">
                <span>Vietnamese (Việt Nam)</span>
            </button>
              </div>
                    </section>
                    <header class="${p}-menu-header">
                        ...
                        <button class="${p}-control-item ${p}--reset-all" id="${p}-lang-btn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24" fill="none"><path d="M22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C21.5093 4.43821 21.8356 5.80655 21.9449 8" stroke="#fff" stroke-width="1.5" stroke-linecap="round"/></svg>
                        <div>TR</div><span>Language</span></button>
                    ...
                    <section class="${p}-section">
                        ...
                        <div class="${p}-control-grid">
                           ...
                           <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M11.25 17C11.25 17.4142 11.5858 17.75 12 17.75C12.4142 17.75 12.75 17.4142 12.75 17H11.25ZM15.25 9.75C15.25 10.1642 15.5858 10.5 16 10.5C16.4142 10.5 16.75 10.1642 16.75 9.75H15.25ZM7.25 9.75C7.25 10.1642 7.58579 10.5 8 10.5C8.41421 10.5 8.75 10.1642 8.75 9.75H7.25ZM15.7071 7.32544L16.2646 6.82371V6.82371L15.7071 7.32544ZM9.5 16.25C9.08579 16.25 8.75 16.5858 8.75 17C8.75 17.4142 9.08579 17.75 9.5 17.75V16.25ZM15 17.75C15.4142 17.75 15.75 17.4142 15.75 17C15.75 16.5858 15.4142 16.25 15 16.25V17.75ZM10 7.75H12V6.25H10V7.75ZM12 7.75H14V6.25H12V7.75ZM12.75 17V7H11.25V17H12.75ZM15.25 9.22222V9.75H16.75V9.22222H15.25ZM7.25 9.22222V9.75H8.75V9.22222H7.25ZM14 7.75C14.4949 7.75 14.7824 7.75196 14.9865 7.78245C15.0783 7.79617 15.121 7.8118 15.1376 7.8194C15.148 7.82415 15.1477 7.82503 15.1496 7.82716L16.2646 6.82371C15.96 6.4853 15.579 6.35432 15.2081 6.29891C14.8676 6.24804 14.4479 6.25 14 6.25V7.75ZM16.75 9.22222C16.75 8.71757 16.7513 8.27109 16.708 7.91294C16.6629 7.54061 16.559 7.15082 16.2646 6.82371L15.1496 7.82716C15.1523 7.83015 15.1609 7.83939 15.1731 7.87221C15.1873 7.91048 15.2048 7.97725 15.2188 8.09313C15.2487 8.34011 15.25 8.67931 15.25 9.22222H16.75ZM10 6.25C9.55208 6.25 9.13244 6.24804 8.79192 6.29891C8.42102 6.35432 8.04 6.4853 7.73542 6.82371L8.85036 7.82716C8.85228 7.82503 8.85204 7.82415 8.86242 7.8194C8.87904 7.8118 8.92168 7.79617 9.01354 7.78245C9.21765 7.75196 9.50511 7.75 10 7.75V6.25ZM8.75 9.22222C8.75 8.67931 8.75129 8.34011 8.78118 8.09313C8.7952 7.97725 8.81273 7.91048 8.8269 7.87221C8.83905 7.83939 8.84767 7.83015 8.85036 7.82716L7.73542 6.82371C7.44103 7.15082 7.3371 7.54061 7.29204 7.91294C7.24871 8.27109 7.25 8.71757 7.25 9.22222H8.75ZM9.5 17.75H15V16.25H9.5V17.75Z" fill="var(--${p}-primary)"/><path d="M22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C21.5093 4.43821 21.8356 5.80655 21.9449 8" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/></svg>
                            ...
                            <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M4 21H13M20 21H17" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M4 3H20" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 5.5L15 8.5M12 5.5L9 8.5M12 5.5V18.5M12 18.5L15 15.5M12 18.5L9 15.5" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                            <div>${l.lineHeight}</div></div>
                            <span></span>
                            </div>
                            <div class="${p}-control-item" id="${p}-letter-spacing-btn"><div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M22 12C22 15.7712 22 17.6569 20.8284 18.8284C19.6569 20 17.7712 20 14 20H10C6.22876 20 4.34315 20 3.17157 18.8284C2 17.6569 2 15.7712 2 12C2 8.22876 2 6.34315 3.17157 5.17157C4.34315 4 6.22876 4 10 4H14C17.7712 4 19.6569 4 20.8284 5.17157C21.4816 5.82475 21.7706 6.69989 21.8985 8" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M8.25 15.5C8.25 15.9142 8.58579 16.25 9 16.25C9.41421 16.25 9.75 15.9142 9.75 15.5H8.25ZM11.6643 8.75249L12.1624 8.19186L12.1624 8.19186L11.6643 8.75249ZM11.25 10.425C11.25 10.8392 11.5858 11.175 12 11.175C12.4142 11.175 12.75 10.8392 12.75 10.425H11.25ZM11.7475 8.83575L12.3081 8.33756L12.3081 8.33756L11.7475 8.83575ZM6.33575 8.75249L5.83756 8.19186L5.83756 8.19186L6.33575 8.75249ZM5.25 10.425C5.25 10.8392 5.58579 11.175 6 11.175C6.41421 11.175 6.75 10.8392 6.75 10.425H5.25ZM6.25249 8.83575L5.69186 8.33756L5.69186 8.33756L6.25249 8.83575ZM7 14.75C6.58579 14.75 6.25 15.0858 6.25 15.5C6.25 15.9142 6.58579 16.25 7 16.25V14.75ZM11 16.25C11.4142 16.25 11.75 15.9142 11.75 15.5C11.75 15.0858 11.4142 14.75 11 14.75V16.25ZM7.925 9.25H9V7.75H7.925V9.25ZM9 9.25H10.075V7.75H9V9.25ZM9.75 15.5V8.5H8.25V15.5H9.75ZM10.075 9.25C10.5295 9.25 10.8007 9.25137 10.9965 9.27579C11.1739 9.29792 11.1831 9.3283 11.1661 9.31312L12.1624 8.19186C11.8612 7.92419 11.5109 7.82832 11.1822 7.78733C10.8719 7.74863 10.4905 7.75 10.075 7.75V9.25ZM12.75 10.425C12.75 10.0095 12.7514 9.62806 12.7127 9.31782C12.6717 8.98915 12.5758 8.63878 12.3081 8.33756L11.1869 9.33394C11.1717 9.31686 11.2021 9.32608 11.2242 9.50348C11.2486 9.69931 11.25 9.97047 11.25 10.425H12.75ZM11.1661 9.31312C11.1734 9.31964 11.1804 9.32659 11.1869 9.33394L12.3081 8.33756C12.2625 8.28617 12.2138 8.23752 12.1624 8.19186L11.1661 9.31312ZM7.925 7.75C7.50946 7.75 7.12806 7.74863 6.81782 7.78733C6.48914 7.82832 6.13878 7.92419 5.83756 8.19186L6.83394 9.31312C6.81686 9.3283 6.82608 9.29792 7.00348 9.27579C7.19931 9.25137 7.47047 9.25 7.925 9.25V7.75ZM6.75 10.425C6.75 9.97047 6.75137 9.69931 6.77579 9.50348C6.79792 9.32608 6.8283 9.31686 6.81312 9.33394L5.69186 8.33756C5.42419 8.63878 5.32832 8.98915 5.28733 9.31782C5.24863 9.62806 5.25 10.0095 5.25 10.425H6.75ZM5.83756 8.19186C5.78617 8.23752 5.73752 8.28617 5.69186 8.33756L6.81312 9.33394C6.81965 9.3266 6.8266 9.31965 6.83394 9.31312L5.83756 8.19186ZM7 16.25H11V14.75H7V16.25Z" fill="var(--${p}-primary)"/></svg>
                            <div>${l.letterSpacing}</div></div>  <span></span></div>
                            <div class="${p}-control-item" id="${p}-text-align-btn"><div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M21 14L21 2M21 22L21 18" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M11 5L5.5 5C4.56538 5 4.09808 5 3.75 5.20096C3.52197 5.33261 3.33261 5.52197 3.20096 5.75C3 6.09808 3 6.56538 3 7.5C3 8.43462 3 8.90192 3.20096 9.25C3.33261 9.47803 3.52197 9.66739 3.75 9.79904C4.09808 10 4.56538 10 5.5 10L14.5 10C15.4346 10 15.9019 10 16.25 9.79904C16.478 9.66739 16.6674 9.47803 16.799 9.25C17 8.90192 17 8.43462 17 7.5C17 6.56538 17 6.09808 16.799 5.75C16.6674 5.52197 16.478 5.33261 16.25 5.20096C15.9704 5.03954 15.6139 5.00778 15 5.00153" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M17 16.5C17 15.5654 17 15.0981 16.799 14.75C16.6674 14.522 16.478 14.3326 16.25 14.201C15.9019 14 15.4346 14 14.5 14H8.5C7.56538 14 7.09808 14 6.75 14.201C6.52197 14.3326 6.33261 14.522 6.20096 14.75C6 15.0981 6 15.5654 6 16.5C6 17.4346 6 17.9019 6.20096 18.25C6.33261 18.478 6.52197 18.6674 6.75 18.799C7.09808 19 7.56538 19 8.5 19H14.5C15.4346 19 15.9019 19 16.25 18.799C16.478 18.6674 16.6674 18.478 16.799 18.25C17 17.9019 17 17.4346 17 16.5Z" stroke="var(--${p}-primary)" stroke-width="1.5"/></svg>
                            <div>${l.textAlign}</div></div>  <span></span></div>
                            <div class="${p}-control-item" id="${p}-word-spacing-btn" style="justify-content: space-between; cursor: pointer;"><div>
                              <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M8.25 15.5C8.25 15.9142 8.58579 16.25 9 16.25C9.41421 16.25 9.75 15.9142 9.75 15.5H8.25ZM11.6643 8.75249L12.1624 8.19186L12.1624 8.19186L11.6643 8.75249ZM11.25 10.425C11.25 10.8392 11.5858 11.175 12 11.175C12.4142 11.175 12.75 10.8392 12.75 10.425H11.25ZM11.7475 8.83575L12.3081 8.33756L12.3081 8.33756L11.7475 8.83575ZM6.33575 8.75249L5.83756 8.19186L5.83756 8.19186L6.33575 8.75249ZM5.25 10.425C5.25 10.8392 5.58579 11.175 6 11.175C6.41421 11.175 6.75 10.8392 6.75 10.425H5.25ZM6.25249 8.83575L5.69186 8.33756L5.69186 8.33756L6.25249 8.83575ZM7 14.75C6.58579 14.75 6.25 15.0858 6.25 15.5C6.25 15.9142 6.58579 16.25 7 16.25V14.75ZM11 16.25C11.4142 16.25 11.75 15.9142 11.75 15.5C11.75 15.0858 11.4142 14.75 11 14.75V16.25ZM7.925 9.25H9V7.75H7.925V9.25ZM9 9.25H10.075V7.75H9V9.25ZM9.75 15.5V8.5H8.25V15.5H9.75ZM10.075 9.25C10.5295 9.25 10.8007 9.25137 10.9965 9.27579C11.1739 9.29792 11.1831 9.3283 11.1661 9.31312L12.1624 8.19186C11.8612 7.92419 11.5109 7.82832 11.1822 7.78733C10.8719 7.74863 10.4905 7.75 10.075 7.75V9.25ZM12.75 10.425C12.75 10.0095 12.7514 9.62806 12.7127 9.31782C12.6717 8.98915 12.5758 8.63878 12.3081 8.33756L11.1869 9.33394C11.1717 9.31686 11.2021 9.32608 11.2242 9.50348C11.2486 9.69931 11.25 9.97047 11.25 10.425H12.75ZM11.1661 9.31312C11.1734 9.31964 11.1804 9.32659 11.1869 9.33394L12.3081 8.33756C12.2625 8.28617 12.2138 8.23752 12.1624 8.19186L11.1661 9.31312ZM7.925 7.75C7.50946 7.75 7.12806 7.74863 6.81782 7.78733C6.48914 7.82832 6.13878 7.92419 5.83756 8.19186L6.83394 9.31312C6.81686 9.3283 6.82608 9.29792 7.00348 9.27579C7.19931 9.25137 7.47047 9.25 7.925 9.25V7.75ZM6.75 10.425C6.75 9.97047 6.75137 9.69931 6.77579 9.50348C6.79792 9.32608 6.8283 9.31686 6.81312 9.33394L5.69186 8.33756C5.42419 8.63878 5.32832 8.98915 5.28733 9.31782C5.24863 9.62806 5.25 10.0095 5.25 10.425H6.75ZM5.83756 8.19186C5.78617 8.23752 5.73752 8.28617 5.69186 8.33756L6.81312 9.33394C6.81965 9.3266 6.8266 9.31965 6.83394 9.31312L5.83756 8.19186ZM7 16.25H11V14.75H7V16.25Z" fill="var(--${p}-primary)"/><path d="M22 12C22 15.7712 22 17.6569 20.8284 18.8284C19.7653 19.8915 18.1143 19.99 15 19.9991M12 4H10C6.22876 4 4.34315 4 3.17157 5.17157C2 6.34315 2 8.22876 2 12C2 15.7712 2 17.6569 3.17157 18.8284C4.34315 20 6.22876 20 10 20H12M15 4.00093C18.1143 4.01004 19.7653 4.10848 20.8284 5.17157C21.4816 5.82475 21.7706 6.69989 21.8985 8" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M15 2V22" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/></svg>
                               <div>${l.wordSpacing}</div></div><span></span>
                            </div>
                            <div class="${p}-control-item" style="justify-content: space-between;"><div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M14 7.07026C12.8233 6.38958 11.4571 6 10 6C5.58172 6 2 9.58172 2 14C2 15.2797 2.30049 16.4893 2.83477 17.562C2.97675 17.847 3.02401 18.1729 2.94169 18.4805L2.46521 20.2613C2.25836 21.0344 2.96561 21.7416 3.73868 21.5348L5.51951 21.0583C5.82715 20.976 6.15297 21.0233 6.43802 21.1652C7.51069 21.6995 8.72025 22 10 22C14.4183 22 18 18.4183 18 14C18 12.5429 17.6104 11.1767 16.9297 10" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M18 14.5018C18.0665 14.4741 18.1324 14.4453 18.1977 14.4155C18.5598 14.2501 18.9661 14.1882 19.3506 14.2911L19.8267 14.4185C20.793 14.677 21.677 13.793 21.4185 12.8267L21.2911 12.3506C21.1882 11.9661 21.2501 11.5598 21.4155 11.1977C21.7908 10.376 22 9.46242 22 8.5C22 7.22592 21.6334 6.03745 21 5.03431M9.5 5.9956C10.4806 3.64899 12.7977 2 15.5 2C16.7886 2 17.9897 2.375 19 3.02182" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M6.51828 14H6.52728M10.009 14H10.018M13.5 14H13.509" stroke="var(--${p}-primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                            İpucu</div>
                    ...
                    <section class="${p}-section">
                        ...
                        <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M8.5 7L8.5 14M8.5 14L11 11M8.5 14L6 11" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M15.5 7L15.5 14M15.5 14L18 11M15.5 14L13 11" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M18 17H12H6" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"></path><path d="M22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C21.5093 4.43821 21.8356 5.80655 21.9449 8" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"></path></svg>
                        ${l.readingGuide}</div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M13.0867 21.3877L13.7321 21.7697L13.0867 21.3877ZM13.6288 20.4718L12.9833 20.0898L13.6288 20.4718ZM10.3712 20.4718L9.72579 20.8539H9.72579L10.3712 20.4718ZM10.9133 21.3877L11.5587 21.0057L10.9133 21.3877ZM1.25 10.5C1.25 10.9142 1.58579 11.25 2 11.25C2.41421 11.25 2.75 10.9142 2.75 10.5H1.25ZM3.07351 15.6264C2.915 15.2437 2.47627 15.062 2.09359 15.2205C1.71091 15.379 1.52918 15.8177 1.68769 16.2004L3.07351 15.6264ZM7.78958 18.9915L7.77666 19.7413L7.78958 18.9915ZM5.08658 18.6194L4.79957 19.3123H4.79957L5.08658 18.6194ZM21.6194 15.9134L22.3123 16.2004V16.2004L21.6194 15.9134ZM16.2104 18.9915L16.1975 18.2416L16.2104 18.9915ZM18.9134 18.6194L19.2004 19.3123H19.2004L18.9134 18.6194ZM19.6125 2.7368L19.2206 3.37628L19.6125 2.7368ZM21.2632 4.38751L21.9027 3.99563V3.99563L21.2632 4.38751ZM4.38751 2.7368L3.99563 2.09732V2.09732L4.38751 2.7368ZM2.7368 4.38751L2.09732 3.99563H2.09732L2.7368 4.38751ZM9.40279 19.2098L9.77986 18.5615L9.77986 18.5615L9.40279 19.2098ZM13.7321 21.7697L14.2742 20.8539L12.9833 20.0898L12.4412 21.0057L13.7321 21.7697ZM9.72579 20.8539L10.2679 21.7697L11.5587 21.0057L11.0166 20.0898L9.72579 20.8539ZM12.4412 21.0057C12.2485 21.3313 11.7515 21.3313 11.5587 21.0057L10.2679 21.7697C11.0415 23.0767 12.9585 23.0767 13.7321 21.7697L12.4412 21.0057ZM10.5 2.75H13.5V1.25H10.5V2.75ZM21.25 10.5V11.5H22.75V10.5H21.25ZM7.8025 18.2416C6.54706 18.2199 5.88923 18.1401 5.37359 17.9265L4.79957 19.3123C5.60454 19.6457 6.52138 19.7197 7.77666 19.7413L7.8025 18.2416ZM1.68769 16.2004C2.27128 17.6093 3.39066 18.7287 4.79957 19.3123L5.3736 17.9265C4.33223 17.4951 3.50486 16.6678 3.07351 15.6264L1.68769 16.2004ZM21.25 11.5C21.25 12.6751 21.2496 13.5189 21.2042 14.1847C21.1592 14.8438 21.0726 15.2736 20.9265 15.6264L22.3123 16.2004C22.5468 15.6344 22.6505 15.0223 22.7007 14.2868C22.7504 13.5581 22.75 12.6546 22.75 11.5H21.25ZM16.2233 19.7413C17.4786 19.7197 18.3955 19.6457 19.2004 19.3123L18.6264 17.9265C18.1108 18.1401 17.4529 18.2199 16.1975 18.2416L16.2233 19.7413ZM20.9265 15.6264C20.4951 16.6678 19.6678 17.4951 18.6264 17.9265L19.2004 19.3123C20.6093 18.7287 21.7287 17.6093 22.3123 16.2004L20.9265 15.6264ZM13.5 2.75C15.1512 2.75 16.337 2.75079 17.2619 2.83873C18.1757 2.92561 18.7571 3.09223 19.2206 3.37628L20.0044 2.09732C19.2655 1.64457 18.4274 1.44279 17.4039 1.34547C16.3915 1.24921 15.1222 1.25 13.5 1.25V2.75ZM22.75 10.5C22.75 8.87781 22.7508 7.6085 22.6545 6.59611C22.5572 5.57256 22.3554 4.73445 21.9027 3.99563L20.6237 4.77938C20.9078 5.24291 21.0744 5.82434 21.1613 6.73809C21.2492 7.663 21.25 8.84876 21.25 10.5H22.75ZM19.2206 3.37628C19.7925 3.72672 20.2733 4.20752 20.6237 4.77938L21.9027 3.99563C21.4286 3.22194 20.7781 2.57144 20.0044 2.09732L19.2206 3.37628ZM10.5 1.25C8.87781 1.25 7.6085 1.24921 6.59611 1.34547C5.57256 1.44279 4.73445 1.64457 3.99563 2.09732L4.77938 3.37628C5.24291 3.09223 5.82434 2.92561 6.73809 2.83873C7.663 2.75079 8.84876 2.75 10.5 2.75V1.25ZM2.75 10.5C2.75 8.84876 2.75079 7.663 2.83873 6.73809C2.92561 5.82434 3.09223 5.24291 3.37628 4.77938L2.09732 3.99563C1.64457 4.73445 1.44279 5.57256 1.34547 6.59611C1.24921 7.6085 1.25 8.87781 1.25 10.5H2.75ZM3.99563 2.09732C3.22194 2.57144 2.57144 3.22194 2.09732 3.99563L3.37628 4.77938C3.72672 4.20752 4.20752 3.72672 4.77938 3.37628L3.99563 2.09732ZM11.0166 20.0898C10.8136 19.7468 10.6354 19.4441 10.4621 19.2063C10.2795 18.9559 10.0702 18.7304 9.77986 18.5615L9.02572 19.8582C9.07313 19.8857 9.13772 19.936 9.24985 20.0898C9.37122 20.2564 9.50835 20.4865 9.72579 20.8539L11.0166 20.0898ZM7.77666 19.7413C8.21575 19.7489 8.49387 19.7545 8.70588 19.7779C8.90399 19.7999 8.98078 19.832 9.02572 19.8582L9.77986 18.5615C9.4871 18.3912 9.18246 18.3215 8.87097 18.287C8.57339 18.2541 8.21375 18.2487 7.8025 18.2416L7.77666 19.7413ZM14.2742 20.8539C14.4916 20.4865 14.6287 20.2564 14.7501 20.0898C14.8622 19.936 14.9268 19.8857 14.9742 19.8582L14.2201 18.5615C13.9298 18.7304 13.7204 18.9559 13.5379 19.2063C13.3646 19.4441 13.1864 19.7468 12.9833 20.0898L14.2742 20.8539ZM16.1975 18.2416C15.7862 18.2487 15.4266 18.2541 15.129 18.287C14.8175 18.3215 14.5129 18.3912 14.2201 18.5615L14.9742 19.8582C15.0192 19.832 15.096 19.7999 15.2941 19.7779C15.5061 19.7545 15.7842 19.7489 16.2233 19.7413L16.1975 18.2416Z" fill="var(--${p}-primary)"/><path d="M9 11.08L11 13L15 9" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        </div>
                        <div class="${p}-control-item" style="justify-content: space-between;">
                        <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M14.1625 18.4876L13.4417 19.2084C11.053 21.5971 7.18019 21.5971 4.79151 19.2084C2.40283 16.8198 2.40283 12.9469 4.79151 10.5583L5.51236 9.8374" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M9.8374 14.1625L14.1625 9.8374" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M9.8374 5.51236L10.5583 4.79151C12.9469 2.40283 16.8198 2.40283 19.2084 4.79151M18.4876 14.1625L19.2084 13.4417C20.4324 12.2177 21.0292 10.604 20.9988 9" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/></svg>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" fill="none"><path d="M9 4.94198C6.47561 4.02693 5.129 3.65381 4.39141 4.39141C3.55146 5.23136 4.15187 6.86106 5.3527 10.1205L7.3603 15.5696C7.96225 17.2035 8.26322 18.0204 8.92489 18.1658C9.58656 18.3111 10.2022 17.6955 11.4334 16.4643L12.6361 15.2616L16.5744 19.1999C16.9821 19.6077 17.186 19.8116 17.4135 19.9058C17.7168 20.0314 18.0575 20.0314 18.3608 19.9058C18.5882 19.8116 18.7921 19.6077 19.1999 19.1999C19.6077 18.7921 19.8116 18.5882 19.9058 18.3608C20.0314 18.0575 20.0314 17.7168 19.9058 17.4135C19.8116 17.186 19.6077 16.9821 19.1999 16.5744L15.2616 12.6361L16.4643 11.4334C17.6955 10.2022 18.3111 9.58656 18.1658 8.92489C18.0204 8.26322 17.2035 7.96225 15.5696 7.3603L13 6.41359" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        <span>${l.cursor}</span></div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M13.0867 21.3877L13.7321 21.7697L13.0867 21.3877ZM13.6288 20.4718L12.9833 20.0898L13.6288 20.4718ZM10.3712 20.4718L9.72579 20.8539H9.72579L10.3712 20.4718ZM10.9133 21.3877L11.5587 21.0057L10.9133 21.3877ZM1.25 10.5C1.25 10.9142 1.58579 11.25 2 11.25C2.41421 11.25 2.75 10.9142 2.75 10.5H1.25ZM3.07351 15.6264C2.915 15.2437 2.47627 15.062 2.09359 15.2205C1.71091 15.379 1.52918 15.8177 1.68769 16.2004L3.07351 15.6264ZM7.78958 18.9915L7.77666 19.7413L7.78958 18.9915ZM5.08658 18.6194L4.79957 19.3123H4.79957L5.08658 18.6194ZM21.6194 15.9134L22.3123 16.2004V16.2004L21.6194 15.9134ZM16.2104 18.9915L16.1975 18.2416L16.2104 18.9915ZM18.9134 18.6194L19.2004 19.3123H19.2004L18.9134 18.6194ZM19.6125 2.7368L19.2206 3.37628L19.6125 2.7368ZM21.2632 4.38751L21.9027 3.99563V3.99563L21.2632 4.38751ZM4.38751 2.7368L3.99563 2.09732V2.09732L4.38751 2.7368ZM2.7368 4.38751L2.09732 3.99563H2.09732L2.7368 4.38751ZM9.40279 19.2098L9.77986 18.5615L9.77986 18.5615L9.40279 19.2098ZM13.7321 21.7697L14.2742 20.8539L12.9833 20.0898L12.4412 21.0057L13.7321 21.7697ZM9.72579 20.8539L10.2679 21.7697L11.5587 21.0057L11.0166 20.0898L9.72579 20.8539ZM12.4412 21.0057C12.2485 21.3313 11.7515 21.3313 11.5587 21.0057L10.2679 21.7697C11.0415 23.0767 12.9585 23.0767 13.7321 21.7697L12.4412 21.0057ZM10.5 2.75H13.5V1.25H10.5V2.75ZM21.25 10.5V11.5H22.75V10.5H21.25ZM7.8025 18.2416C6.54706 18.2199 5.88923 18.1401 5.37359 17.9265L4.79957 19.3123C5.60454 19.6457 6.52138 19.7197 7.77666 19.7413L7.8025 18.2416ZM1.68769 16.2004C2.27128 17.6093 3.39066 18.7287 4.79957 19.3123L5.3736 17.9265C4.33223 17.4951 3.50486 16.6678 3.07351 15.6264L1.68769 16.2004ZM21.25 11.5C21.25 12.6751 21.2496 13.5189 21.2042 14.1847C21.1592 14.8438 21.0726 15.2736 20.9265 15.6264L22.3123 16.2004C22.5468 15.6344 22.6505 15.0223 22.7007 14.2868C22.7504 13.5581 22.75 12.6546 22.75 11.5H21.25ZM16.2233 19.7413C17.4786 19.7197 18.3955 19.6457 19.2004 19.3123L18.6264 17.9265C18.1108 18.1401 17.4529 18.2199 16.1975 18.2416L16.2233 19.7413ZM20.9265 15.6264C20.4951 16.6678 19.6678 17.4951 18.6264 17.9265L19.2004 19.3123C20.6093 18.7287 21.7287 17.6093 22.3123 16.2004L20.9265 15.6264ZM13.5 2.75C15.1512 2.75 16.337 2.75079 17.2619 2.83873C18.1757 2.92561 18.7571 3.09223 19.2206 3.37628L20.0044 2.09732C19.2655 1.64457 18.4274 1.44279 17.4039 1.34547C16.3915 1.24921 15.1222 1.25 13.5 1.25V2.75ZM22.75 10.5C22.75 8.87781 22.7508 7.6085 22.6545 6.59611C22.5572 5.57256 22.3554 4.73445 21.9027 3.99563L20.6237 4.77938C20.9078 5.24291 21.0744 5.82434 21.1613 6.73809C21.2492 7.663 21.25 8.84876 21.25 10.5H22.75ZM19.2206 3.37628C19.7925 3.72672 20.2733 4.20752 20.6237 4.77938L21.9027 3.99563C21.4286 3.22194 20.7781 2.57144 20.0044 2.09732L19.2206 3.37628ZM10.5 1.25C8.87781 1.25 7.6085 1.24921 6.59611 1.34547C5.57256 1.44279 4.73445 1.64457 3.99563 2.09732L4.77938 3.37628C5.24291 3.09223 5.82434 2.92561 6.73809 2.83873C7.663 2.75079 8.84876 2.75 10.5 2.75V1.25ZM2.75 10.5C2.75 8.84876 2.75079 7.663 2.83873 6.73809C2.92561 5.82434 3.09223 5.24291 3.37628 4.77938L2.09732 3.99563C1.64457 4.73445 1.44279 5.57256 1.34547 6.59611C1.24921 7.6085 1.25 8.87781 1.25 10.5H2.75ZM3.99563 2.09732C3.22194 2.57144 2.57144 3.22194 2.09732 3.99563L3.37628 4.77938C3.72672 4.20752 4.20752 3.72672 4.77938 3.37628L3.99563 2.09732ZM11.0166 20.0898C10.8136 19.7468 10.6354 19.4441 10.4621 19.2063C10.2795 18.9559 10.0702 18.7304 9.77986 18.5615L9.02572 19.8582C9.07313 19.8857 9.13772 19.936 9.24985 20.0898C9.37122 20.2564 9.50835 20.4865 9.72579 20.8539L11.0166 20.0898ZM7.77666 19.7413C8.21575 19.7489 8.49387 19.7545 8.70588 19.7779C8.90399 19.7999 8.98078 19.832 9.02572 19.8582L9.77986 18.5615C9.4871 18.3912 9.18246 18.3215 8.87097 18.287C8.57339 18.2541 8.21375 18.2487 7.8025 18.2416L7.77666 19.7413ZM14.2742 20.8539C14.4916 20.4865 14.6287 20.2564 14.7501 20.0898C14.8622 19.936 14.9268 19.8857 14.9742 19.8582L14.2201 18.5615C13.9298 18.7304 13.7204 18.9559 13.5379 19.2063C13.3646 19.4441 13.1864 19.7468 12.9833 20.0898L14.2742 20.8539ZM16.1975 18.2416C15.7862 18.2487 15.4266 18.2541 15.129 18.287C14.8175 18.3215 14.5129 18.3912 14.2201 18.5615L14.9742 19.8582C15.0192 19.832 15.096 19.7999 15.2941 19.7779C15.5061 19.7545 15.7842 19.7489 16.2233 19.7413L16.1975 18.2416Z" fill="var(--${p}-primary)"/><path d="M9 11.08L11 13L15 9" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        </div>
                        ${config.features.textToSpeech ? `<div class="${p}-control-item" style="justify-content: space-between;"><div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M7 8C7 5.23858 9.23858 3 12 3C14.7614 3 17 5.23858 17 8V11C17 13.7614 14.7614 16 12 16C9.23858 16 7 13.7614 7 11V8Z" stroke="var(--${p}-primary)" stroke-width="1.5"/><path d="M11 8H13" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M10 11L14 11" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M20.75 10C20.75 9.58579 20.4142 9.25 20 9.25C19.5858 9.25 19.25 9.58579 19.25 10H20.75ZM4.75 10C4.75 9.58579 4.41421 9.25 4 9.25C3.58579 9.25 3.25 9.58579 3.25 10H4.75ZM15.5121 17.3442C15.1499 17.5452 15.0192 18.0017 15.2202 18.3639C15.4212 18.7261 15.8777 18.8568 16.2399 18.6558L15.5121 17.3442ZM19.25 10V11H20.75V10H19.25ZM4.75 11V10H3.25V11H4.75ZM12 18.25C7.99594 18.25 4.75 15.0041 4.75 11H3.25C3.25 15.8325 7.16751 19.75 12 19.75V18.25ZM19.25 11C19.25 13.7287 17.7429 16.1063 15.5121 17.3442L16.2399 18.6558C18.928 17.1642 20.75 14.2954 20.75 11H19.25Z" fill="var(--${p}-primary)"/><path d="M12 19V22" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/></svg>
                    ...
                    <section class="${p}-section">
                        <h3 class="${p}-section-title" data-title="appearance">${l.appearance}</h3>
                        <div class="${p}-control-grid-1col">
                        <div class="${p}-control-item" style="justify-content: space-between;"><div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="28px" height="28px" viewBox="0 0 24 24" fill="none"><path d="M7 3.34132C8.47087 2.48824 10.1786 2 12 2C17.5228 2 22 6.48884 22 12.0261C22 20.178 13.8385 14.4192 12.2619 16.9268C11.8674 17.5541 12.2938 18.3364 12.8168 18.8607C13.4703 19.5159 13.4703 20.5781 12.8168 21.2333C12.2938 21.7576 11.5816 22.0709 10.8468 21.9863C5.86713 21.413 2 17.1723 2 12.0261C2 10.1945 2.48985 8.47765 3.34537 7" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><circle cx="17.5" cy="11.5" r="1.5" stroke="var(--${p}-primary)" stroke-width="1.5"/><circle cx="6.5" cy="11.5" r="1.5" stroke="var(--${p}-primary)" stroke-width="1.5"/><path d="M11.085 6.99976C11.085 7.82818 10.4134 8.49976 9.58496 8.49976C8.75653 8.49976 8.08496 7.82818 8.08496 6.99976C8.08496 6.17133 8.75653 5.49976 9.58496 5.49976C10.4134 5.49976 11.085 6.17133 11.085 6.99976Z" stroke="var(--${p}-primary)" stroke-width="1.5"/><path d="M16 7C16 7.82843 15.3284 8.5 14.5 8.5C13.6716 8.5 13 7.82843 13 7C13 6.17157 13.6716 5.5 14.5 5.5C15.3284 5.5 16 6.17157 16 7Z" stroke="var(--${p}-primary)" stroke-width="1.5"/></svg>
                        ${l.darkMode}</div><label class="${p}-toggle"><input type="checkbox" id="${p}-dark-mode"><span class="${p}-toggle-slider"></span></label></div>
                        <div class="${p}-control-item" style="justify-content: space-between;"><div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="28px" height="28px" viewBox="0 0 24 24" fill="none"><path d="M21.1935 16.793C20.8437 19.2739 20.6689 20.5143 19.7717 21.2572C18.8745 22 17.5512 22 14.9046 22H9.09536C6.44881 22 5.12553 22 4.22834 21.2572C3.33115 20.5143 3.15626 19.2739 2.80648 16.793L2.38351 13.793C1.93748 10.6294 1.71447 9.04765 2.66232 8.02383C3.61017 7 5.29758 7 8.67239 7H15.3276C18.7024 7 20.3898 7 21.3377 8.02383C22.0865 8.83268 22.1045 9.98979 21.8592 12" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M19.5617 7C19.7904 5.69523 18.7863 4.5 17.4617 4.5H6.53788C5.21323 4.5 4.20922 5.69523 4.43784 7" stroke="var(--${p}-primary)" stroke-width="1.5"/><path d="M17.4999 4.5C17.5283 4.24092 17.5425 4.11135 17.5427 4.00435C17.545 2.98072 16.7739 2.12064 15.7561 2.01142C15.6497 2 15.5194 2 15.2588 2H8.74099C8.48035 2 8.35002 2 8.24362 2.01142C7.22584 2.12064 6.45481 2.98072 6.45704 4.00434C6.45727 4.11135 6.47146 4.2409 6.49983 4.5" stroke="var(--${p}-primary)" stroke-width="1.5"/><circle cx="16.5" cy="11.5" r="1.5" stroke="var(--${p}-primary)" stroke-width="1.5"/><path d="M19.9999 20L17.1157 17.8514C16.1856 17.1586 14.8004 17.0896 13.7766 17.6851L13.5098 17.8403C12.7984 18.2542 11.8304 18.1848 11.2156 17.6758L7.37738 14.4989C6.6113 13.8648 5.38245 13.8309 4.5671 14.4214L3.24316 15.3803" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/></svg>
                        ${l.hideImages}</div><label class="${p}-toggle"><input type="checkbox" id="${p}-hide-images"><span class="${p}-toggle-slider"></span></label></div>
                        <div class="${p}-control-item" style="justify-content: space-between;"><div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="28px" height="28px" viewBox="0 0 24 24" fill="none"><path d="M15.2683 18.2287C13.2889 20.9067 12.2992 22.2458 11.3758 21.9628C10.4525 21.6798 10.4525 20.0375 10.4525 16.7528L10.4526 16.4433C10.4526 15.2585 10.4526 14.6662 10.074 14.2946L10.054 14.2754C9.6673 13.9117 9.05079 13.9117 7.81775 13.9117C5.59888 13.9117 4.48945 13.9117 4.1145 13.2387C4.10829 13.2276 4.10225 13.2164 4.09639 13.205C3.74244 12.5217 4.3848 11.6526 5.66953 9.91436L8.73167 5.77133C10.711 3.09327 11.7007 1.75425 12.6241 2.03721C13.5474 2.32018 13.5474 3.96249 13.5474 7.24712V7.55682C13.5474 8.74151 13.5474 9.33386 13.926 9.70541L13.946 9.72466C14.3327 10.0884 14.9492 10.0884 16.1822 10.0884C18.4011 10.0884 19.5106 10.0884 19.8855 10.7613C19.8917 10.7724 19.8977 10.7837 19.9036 10.795C20.2576 11.4784 19.6152 12.3475 18.3304 14.0857" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/></svg>
                        ...
                        <div class="${p}-control-grid">
                            ...
                            <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" fill="none"><path d="M7.28451 10.3333C7.10026 10.8546 7 11.4156 7 12C7 14.7614 9.23858 17 12 17C14.7614 17 17 14.7614 17 12C17 9.23858 14.7614 7 12 7C11.4156 7 10.8546 7.10026 10.3333 7.28451" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M12 2V4" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M12 20V22" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M4 12L2 12" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M22 12L20 12" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M19.7778 4.22266L17.5558 6.25424" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M4.22217 4.22266L6.44418 6.25424" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M6.44434 17.5557L4.22211 19.7779" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M19.7778 19.7773L17.5558 17.5551" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/></svg>
                            <div>${l.brightness}</div></div><span></span></div>
                            <div class="${p}-control-item" id="${p}-contrast-btn">
                            <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" fill="none"><path d="M7 8L7 9M7 16L7 12" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M12 12C12 10.8954 12.8954 10 14 10C15.1046 10 16 10.8954 16 12C16 13.1046 15.1046 14 14 14C12.8954 14 12 13.1046 12 12Z" stroke="var(--${p}-primary)" stroke-width="1.5"/><path d="M16 10L17 9" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M11 15L12 14" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M12 10L11 9" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M17 15L16 14" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/></svg>
                            <div>${l.contrast}</div></div><span></span></div>
                            <div class="${p}-control-item" id="${p}-saturation-btn"><div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" fill="none"><path d="M3.44668 16C3.15698 15.1183 3 14.1743 3 13.1928V12.9281C3 8.31651 5.72854 4.16347 9.90329 2.42077C11.2473 1.85974 12.7527 1.85974 14.0967 2.42077C18.2715 4.16347 21 8.31651 21 12.9281V13.1928C21 18.0569 17.1445 22 12.3885 22H11.6115C9.46786 22 7.50718 21.199 6 19.8736" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M7.61475 10.7237C8.2495 8.71826 9.63062 7.08805 11.3858 6.27637" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/></svg>
                            <div>${l.saturation}</div></div><span></span></div>
                           
                        <div class="${p}-control-item" id="${p}-font-family-btn" style="justify-content: space-between; cursor: pointer;">
                         <div>
    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" fill="none"><path d="M9 9H15" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M12 15L12 9" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M6 4C6 5.10457 5.10457 6 4 6C2.89543 6 2 5.10457 2 4C2 2.89543 2.89543 2 4 2C5.10457 2 6 2.89543 6 4Z" stroke="var(--${p}-primary)" stroke-width="1.5"/><path d="M6 20C6 21.1046 5.10457 22 4 22C2.89543 22 2 21.1046 2 20C2 18.8954 2.89543 18 4 18C5.10457 18 6 18.8954 6 20Z" stroke="var(--${p}-primary)" stroke-width="1.5"/><path d="M22 4C22 5.10457 21.1046 6 20 6C18.8954 6 18 5.10457 18 4C18 2.89543 18.8954 2 20 2C21.1046 2 22 2.89543 22 4Z" stroke="var(--${p}-primary)" stroke-width="1.5"/><path d="M22 20C22 21.1046 21.1046 22 20 22C18.8954 22 18 21.1046 18 20C18 18.8954 18.8954 18 20 18C21.1046 18 22 18.8954 22 20Z" stroke="var(--${p}-primary)" stroke-width="1.5"/><path d="M18 4H6" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M20 18L20 12M20 6V8" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M18 20L12 20M6 20L8 20" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M4 6L4 18" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/></svg>
        <div>Okuma Fontu</div> 
    </div>
    <span class="lbl-fnt">Normal</span>
</div>
...
<div class="${p}-control-item" id="${p}-bluelight-btn" style="justify-content: space-between; cursor: pointer;">
    <div>
    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M2 12H9.5M22 12H14.5" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><path d="M20.0002 15.6843C20.0002 19 17.7345 22 16.0002 22C14.7427 22 13.6725 21.0299 12.9682 18.9999M4.14404 8.31567C4.14404 4.99988 6.40978 1.99988 8.14404 1.99988C10.4128 1.99988 12.0723 5.15794 12.0723 12C12.0723 13.0933 12.1146 14.0926 12.1951 14.9999" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/></svg>
    ...
    <span>Kapalı</span>
                    ...
                    <footer class="${p}-menu-footer">
                        <a href="https://www.mobildev.com/"><img src="https://www.mobildev.com/assets/images/logo/logo-01.png" alt="Mobildev"></a>
                    </footer>
                    </div>
                </aside>
        ...
        run: function (config) {
            ...
            const contrastStates = [
                ...
                { value: 'light', label: 'Açık', apply: () => { body.classList.remove(`${p}-dark-mode`, `${p}-contrast-high`); body.classList.add(`${p}-contrast-light`); root.style.setProperty(`--${p}-contrast`, 1); root.style.setProperty(`--${p}-invert`, 0); } },
                { value: 'dark', label: 'Koyu', apply: () => { body.classList.remove(`${p}-contrast-light`, `${p}-contrast-high`); body.classList.add(`${p}-dark-mode`); root.style.setProperty(`--${p}-contrast`, 1); root.style.setProperty(`--${p}-invert`, 0); } },
                { value: 'high', label: 'Yüksek', apply: () => { body.classList.remove(`${p}-contrast-light`, `${p}-dark-mode`); body.classList.add(`${p}-contrast-high`); root.style.setProperty(`--${p}-contrast`, 1.5); root.style.setProperty(`--${p}-invert`, 0); } }
            ];
            const speech = {
            ...
            const createHelper = (elm, ct) => {
                const helperElm = document.createElement('div');
                helperElm.classList.add(`${p}-helper-tooltip`);
                const hIcon = document.createElement('span');
                hIcon.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none"><path d="M12 17V11" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/><circle cx="1" cy="1" r="1" transform="matrix(1 0 0 -1 11 9)" fill="var(--${p}-primary)"/><path d="M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7" stroke="var(--${p}-primary)" stroke-width="1.5" stroke-linecap="round"/></svg>`;
                const hText = document.createElement('div');
                hText.innerText = ct;
                helperElm.appendChild(hIcon);
                helperElm.appendChild(hText);
                elm.appendChild(helperElm);
            };
            ...
            const applySettings = () => {
                ...
                const lhBtn = document.getElementById(`${p}-line-height-btn`); if (lhBtn) lhBtn.querySelector('span').textContent = [{ value: 1, label: 'Sıkışık' }, { value: 1.5, label: 'Normal' }, { value: 1.8, label: 'Geniş' }, { value: 2.2, label: 'Geniş+' }].find(v => v.value === settings.lineHeight).label;
                const lsBtn = document.getElementById(`${p}-letter-spacing-btn`); if (lsBtn) lsBtn.querySelector('span').textContent = [{ value: 0, label: 'Normal' }, { value: 1, label: 'Açık' }, { value: 4, label: 'Açık+' }, { value: 6, label: 'Açık++' }].find(v => v.value === settings.letterSpacing).label;
                const taBtn = document.getElementById(`${p}-text-align-btn`); if (taBtn) taBtn.querySelector('span').textContent = [{ value: 'inherit', label: 'Normal' }, { value: 'left', label: 'Sol' }, { value: 'center', label: 'Orta' }, { value: 'right', label: 'Sağ' }, { value: 'justify', label: 'Yasla' }].find(v => v.value === settings.textAlign).label;

                const brBtn = document.getElementById(`${p}-brightness-btn`); if (brBtn) brBtn.querySelector('span').textContent = [{ value: 80, label: 'Loş' }, { value: 100, label: 'Normal' }, { value: 120, label: 'Açık' }, { value: 150, label: 'Orta' }, { value: 180, label: 'Yüksek' }].find(v => v.value === settings.brightness).label;
                ...
                if (fontBtn) {
                    ...
                    fontBtn.querySelector('span:not(.bionic-word)').textContent = current.label;
                        ...
                        document.querySelectorAll('p, li, h1, h2, h3, h4, h5, h6, div, span').forEach(el => {
                            if (el.children.length === 0 && el.textContent.trim()) {
                                ...
                                el.innerHTML = words.map(word => {
                                    ...
                                    return `<b class="bionic-word">${word.slice(0, half)}</b>${word.slice(half)}`;
                                }).join(' ');
                            }
                        });
                    } else {
                        document.querySelectorAll('.bionic-word').forEach(b => {
            ...
            const setupCycleButton = (btnId, values, settingKey) => {
                ...
                btn.onclick = () => {
                    ...
                    const nextValue = values[step].value;
                    switch (settingKey) {
                        case 'fontSize': scaler.setFontSize(nextValue); break;
                        case 'lineHeight': scaler.setLineHeight(nextValue); break;
                        case 'letterSpacing': scaler.setLetterSpacing(nextValue); break;
                        case 'wordSpacing': scaler.setWordSpacing(nextValue); break;
                        case 'textAlign': scaler.setTextAlign(nextValue); break;
                    }

                    currentElement = values[step];
                    btn.querySelector('span').textContent = `${currentElement.label}`;
                    removeClassByPrefix(btn, 'level');
                    btn.classList.add('level-' + step);
                };
            };

            const setupCycleButtonAppearance = (btnId, values, settingKey) => {
                const btn = document.getElementById(btnId);
            ...
            const sectionTitles = document.querySelectorAll(`.${p}-section-title`);
            sectionTitles.forEach(title => {
                let elmTitle = title.dataset.title;
                helper[elmTitle] && createHelper(title, helper[elmTitle]);
            });
            ...
            setupCycleButton(`${p}-line-height-btn`, [{ value: 1, label: 'Sıkışık' }, { value: 1.5, label: 'Normal' }, { value: 1.8, label: 'Geniş' }, { value: 2.2, label: 'Geniş+' }], 'lineHeight');
            setupCycleButton(`${p}-letter-spacing-btn`, [{ value: 1, label: 'Normal' }, { value: 2, label: 'Açık' }, { value: 3, label: 'Açık+' }, { value: 4, label: 'Açık++' }], 'letterSpacing');
            ...
            setupCycleButtonAppearance(`${p}-brightness-btn`, [{ value: 80, label: 'Loş' }, { value: 100, label: l.brightness }, { value: 120, label: l.brightness + '+' }, { value: 150, label: l.brightness + '++' }], 'brightness');
            setupCycleButtonAppearance(`${p}-contrast-btn`, contrastStates, 'contrastMode');
            setupCycleButtonAppearance(`${p}-saturation-btn`, [{ value: 50, label: 'Düşük Renk' }, { value: 100, label: 'Normal' }, { value: 150, label: 'Yüksek Renk' }, { value: 0, label: 'Siyah Beyaz' }], 'saturation');

            setupCycleButton(`${p}-word-spacing-btn`, [
                { value: 1, label: 'Normal' },
                { value: 2, label: 'Açık' },
                { value: 4, label: 'Açık+' },
                { value: 6, label: 'Çok Açık' }
            ], 'wordSpacing');

            setupCycleButtonAppearance(`${p}-font-family-btn`, [
                { value: 'inter', label: 'Normal' },
                { value: 'atkinson', label: 'Atkinson' },
                { value: 'dyslexic', label: 'Disleksi' },
                { value: 'bionic', label: 'Bionic' }
            ...
            setupCycleButtonAppearance(`${p}-colorblind-btn`, [
                { value: 'none', label: 'Kapalı' },
                { value: 'protanopia', label: 'Protanopi' },
                { value: 'deuteranopia', label: 'Deuteranopi' },
                { value: 'tritanopia', label: 'Tritanopi' }
            ...
            setupCycleButtonAppearance(`${p}-tts-speed-btn`, [
                { value: 0.7, label: 'Yavaş' },
                { value: 1.0, label: 'Normal' },
                { value: 1.5, label: 'Hızlı' },
                { value: 2.0, label: 'Çok Hızlı' }
            ...
            setupCycleButtonAppearance(`${p}-bluelight-btn`, [
                { value: 'off', label: 'Kapalı' },
                { value: 'low', label: 'Hafif' },
                { value: 'medium', label: 'Orta' },
                { value: 'high', label: 'Yoğun' }
            ...
            document.querySelectorAll(`.${p}-profile-card`).forEach(card => {
                const profileItems = card.dataset.profile;
                helper[profileItems] && createHelper(card, helper[profileItems]);

                const activateProfile = () => {
                    if (card.classList.contains("active")) {
                        card.classList.remove("active");
                        localStorage.removeItem(config.localStorageKey); settings = { ...defaultSettings }; applySettings();
                        return false;
                    }
            ...
            document.getElementById(`${p}-reset-all`).onclick = () => { localStorage.removeItem(config.localStorageKey); settings = { ...defaultSettings }; applySettings(); scaler.reset() };
            document.getElementById(`${p}-lang-btn`).onclick = () => { 
                document.getElementById(`${p}-sections-langs`).classList.add('active');
             };
            document.getElementById(`${p}-close-langs`).onclick = () => { 
                document.getElementById(`${p}-sections-langs`).classList.remove('active');
             };
